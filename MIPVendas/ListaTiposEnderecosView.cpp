...
#pragma resource "*.dfm"
TFListaTiposEnderecosView *FListaTiposEnderecosView;
//---------------------------------------------------------------------------
__fastcall TFListaTiposEnderecosView::TFListaTiposEnderecosView(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::EditFilterValueKeyPress(TObject *Sender, System::WideChar &Key)
{
	if(Key == 13)
		BtSearch->Click();
}
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::FormCreate(TObject *Sender)
{
    //CONFIGURAR O FORM
	ConfigurarForm(this);
...
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::StringGrid1DrawCell(TObject *Sender, int ACol,
...
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::StringGrid1DblClick(TObject *Sender)
{
	TiposEnderecos *tipos_endereco = (TiposEnderecos*)controller->recordsList->Items[rowselectRecords - 1];

	FTiposEnderecosView->editar = 1;
	FTiposEnderecosView->tipos_endereco->id = tipos_endereco->id;
	FTiposEnderecosView->tipos_endereco->nome = tipos_endereco->nome;
	FTiposEnderecosView->ShowModal();
}
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::StringGrid1SelectCell(TObject *Sender, int ACol,
...
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::BtSearchClick(TObject *Sender)
{
	gridRecords();
}
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::BtInsertClick(TObject *Sender)
{
	FTiposEnderecosView->editar = 0;
	FTiposEnderecosView->ShowModal();
}
//---------------------------------------------------------------------------
void __fastcall TFListaTiposEnderecosView::FormDestroy(TObject *Sender)
{
    delete controller;
}
//---------------------------------------------------------------------------
void TFListaTiposEnderecosView::gridRecords()
{
...
//---------------------------------------------------------------------------
void TFListaTiposEnderecosView::loadView()
{
...
void __fastcall TFListaTiposEnderecosView::StringGridFieldsDrawCell(TObject *Sender,
...
void __fastcall TFListaTiposEnderecosView::StringGridFieldsSelectCell(TObject *Sender,
...
void __fastcall TFListaTiposEnderecosView::ButtonFiltroClick(TObject *Sender)
{
...
void __fastcall TFListaTiposEnderecosView::CheckFilterAdvancedClick(TObject *Sender)
{
...
void __fastcall TFListaTiposEnderecosView::StringGridFiltersDrawCell(TObject *Sender,
          int ACol, int ARow, TRect &Rect, TGridDrawState State)
{
    UnicodeString Texto;
	tagRECT *rc;
...
void __fastcall TFListaTiposEnderecosView::StringGridSortDrawCell(TObject *Sender, int ACol,
          int ARow, TRect &Rect, TGridDrawState State)
{
    UnicodeString Texto;
	tagRECT *rc;
...
void __fastcall TFListaTiposEnderecosView::StringGridFiltersSelectCell(TObject *Sender, int ACol,
          int ARow, bool &CanSelect)
{
...
void __fastcall TFListaTiposEnderecosView::StringGridFiltersMouseDown(TObject *Sender, TMouseButton Button,
...
void __fastcall TFListaTiposEnderecosView::StringGridFieldsMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	TList *fields = controller->getFields()->getVisible();
...
void __fastcall TFListaTiposEnderecosView::Button1Click(TObject *Sender)
{
    controller->deleteFilter();
}
//---------------------------------------------------------------------------

void __fastcall TFListaTiposEnderecosView::Button2Click(TObject *Sender)
{
    controller->addSort();
}
//---------------------------------------------------------------------------

void __fastcall TFListaTiposEnderecosView::Button3Click(TObject *Sender)
{
    controller->deleteSort();
}
//---------------------------------------------------------------------------

void __fastcall TFListaTiposEnderecosView::StringGridSortMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	TList *sortsList = controller->queryParams->sorts->sorts;
...
void __fastcall TFListaTiposEnderecosView::StringGridSortSelectCell(TObject *Sender, int ACol, int ARow,
          bool &CanSelect)
{
	rowselectSorts = ARow;
	colselectSorts = ACol;
...
void __fastcall TFListaTiposEnderecosView::FormShow(TObject *Sender)
{
	//STYLE DO FORM
	Style::setTop(LabelCabecalhoTitulo, LabelCabecalhoSubTitulo, "Tipos de Endereço");

	loadView();
}
//---------------------------------------------------------------------------

void __fastcall TFListaTiposEnderecosView::StringGrid1MouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	if(helperGridRecords)
		if(helperGridRecords->checkBox)
