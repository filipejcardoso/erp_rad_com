...
#pragma resource "*.dfm"
TFListaGruposAssociadosView *FListaGruposAssociadosView;
//---------------------------------------------------------------------------
__fastcall TFListaGruposAssociadosView::TFListaGruposAssociadosView(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::EditFilterValueKeyPress(TObject *Sender, System::WideChar &Key)
{
	if(Key == 13)
		BtSearch->Click();
}
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::FormCreate(TObject *Sender)
{
    //CONFIGURAR O FORM
	ConfigurarForm(this);
...
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::StringGrid1DrawCell(TObject *Sender, int ACol,
...
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::StringGrid1DblClick(TObject *Sender)
{
	GruposAssociados *grupos_associado = (GruposAssociados*)controller->recordsList->Items[rowselectRecords - 1];

	FGruposAssociadosView->editar = 1;
	FGruposAssociadosView->grupos_associado->id = grupos_associado->id;
	FGruposAssociadosView->grupos_associado->nome = grupos_associado->nome;
	FGruposAssociadosView->ShowModal();
}
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::StringGrid1SelectCell(TObject *Sender, int ACol,
...
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::BtSearchClick(TObject *Sender)
{
	gridRecords();
}
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::BtInsertClick(TObject *Sender)
{
	FGruposAssociadosView->editar = 0;
	FGruposAssociadosView->ShowModal();
}
//---------------------------------------------------------------------------
void __fastcall TFListaGruposAssociadosView::FormDestroy(TObject *Sender)
{
    delete controller;
}
//---------------------------------------------------------------------------
void TFListaGruposAssociadosView::gridRecords()
{
...
//---------------------------------------------------------------------------
void TFListaGruposAssociadosView::loadView()
{
...
void __fastcall TFListaGruposAssociadosView::StringGridFieldsDrawCell(TObject *Sender,
...
void __fastcall TFListaGruposAssociadosView::StringGridFieldsSelectCell(TObject *Sender,
...
void __fastcall TFListaGruposAssociadosView::ButtonFiltroClick(TObject *Sender)
{
...
void __fastcall TFListaGruposAssociadosView::CheckFilterAdvancedClick(TObject *Sender)
{
...
void __fastcall TFListaGruposAssociadosView::StringGridFiltersDrawCell(TObject *Sender,
          int ACol, int ARow, TRect &Rect, TGridDrawState State)
{
    UnicodeString Texto;
	tagRECT *rc;
...
void __fastcall TFListaGruposAssociadosView::StringGridSortDrawCell(TObject *Sender, int ACol,
          int ARow, TRect &Rect, TGridDrawState State)
{
    UnicodeString Texto;
	tagRECT *rc;
...
void __fastcall TFListaGruposAssociadosView::StringGridFiltersSelectCell(TObject *Sender, int ACol,
          int ARow, bool &CanSelect)
{
...
void __fastcall TFListaGruposAssociadosView::StringGridFiltersMouseDown(TObject *Sender, TMouseButton Button,
...
void __fastcall TFListaGruposAssociadosView::StringGridFieldsMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	TList *fields = controller->getFields()->getVisible();
...
void __fastcall TFListaGruposAssociadosView::Button1Click(TObject *Sender)
{
    controller->deleteFilter();
}
//---------------------------------------------------------------------------

void __fastcall TFListaGruposAssociadosView::Button2Click(TObject *Sender)
{
    controller->addSort();
}
//---------------------------------------------------------------------------

void __fastcall TFListaGruposAssociadosView::Button3Click(TObject *Sender)
{
    controller->deleteSort();
}
//---------------------------------------------------------------------------

void __fastcall TFListaGruposAssociadosView::StringGridSortMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	TList *sortsList = controller->queryParams->sorts->sorts;
...
void __fastcall TFListaGruposAssociadosView::StringGridSortSelectCell(TObject *Sender, int ACol, int ARow,
          bool &CanSelect)
{
	rowselectSorts = ARow;
	colselectSorts = ACol;
...
void __fastcall TFListaGruposAssociadosView::FormShow(TObject *Sender)
{
	//STYLE DO FORM
	Style::setTop(LabelCabecalhoTitulo, LabelCabecalhoSubTitulo, "Grupos de Clientes");

	loadView();
}
//---------------------------------------------------------------------------

void __fastcall TFListaGruposAssociadosView::StringGrid1MouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	if(helperGridRecords)
		if(helperGridRecords->checkBox)
