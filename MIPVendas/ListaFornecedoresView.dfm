object FListaFornecedoresView: TFListaFornecedoresView
  Left = 0
  Top = 0
  Caption = 'CRUD - Fornecedores'
  ClientHeight = 960
  ClientWidth = 1112
  Color = clBtnFace
  ...
  object PanelTitle: TPanel
    ...
    object LabelCabecalhoTitulo: TLabel
      ...
      Width = 726
      Height = 40
      Caption = '[FORNECEDORES] Sistema de Gest'#227'o ERP MIPVendas'
      Color = clRed
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 3198613
      Font.Height = 40
  ...
  object PanelFornecedore: TPanel
    Left = 361
    Top = 178
    Width = 751
    Height = 782
