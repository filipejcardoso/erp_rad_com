...
#ifndef ListaFornecedoresViewH
#define ListaFornecedoresViewH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TFListaFornecedoresView : public TForm
{
__published:	// IDE-managed Components
	...
	TPanel *PanelFornecedore;
	TPanel *PanelAddPedido;
...
public:
	...
	__fastcall TFListaFornecedoresView(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TFListaFornecedoresView *FListaFornecedoresView;
//---------------------------------------------------------------------------
#endif
