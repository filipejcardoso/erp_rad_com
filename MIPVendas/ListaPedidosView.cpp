...
#pragma resource "*.dfm"
TFListaPedidosView *FListaPedidosView;
//---------------------------------------------------------------------------
__fastcall TFListaPedidosView::TFListaPedidosView(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::EditFilterValueKeyPress(TObject *Sender, System::WideChar &Key)
{
	if(Key == 13)
		BtSearch->Click();
}
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::FormCreate(TObject *Sender)
{
    //CONFIGURAR O FORM
	ConfigurarForm(this);
...
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::StringGrid1DrawCell(TObject *Sender, int ACol,
...
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::StringGrid1DblClick(TObject *Sender)
{
	FPedidosView->pedido->id = StrToInt(StringGrid1->Cells[0][rowselectRecords]);

	PedidosController *pedidosController = new PedidosController();
	pedidosController->showPedido(1);
}
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::StringGrid1SelectCell(TObject *Sender, int ACol,
...
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::BtSearchClick(TObject *Sender)
{
	gridRecords();
}
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::BtInsertClick(TObject *Sender)
{
	FPedidosView->editar = 0;
	FPedidosView->ShowModal();
}
//---------------------------------------------------------------------------
void __fastcall TFListaPedidosView::FormDestroy(TObject *Sender)
{
    delete controller;
}
//---------------------------------------------------------------------------
void TFListaPedidosView::gridRecords()
{
...
//---------------------------------------------------------------------------
void TFListaPedidosView::loadView()
{
...
void __fastcall TFListaPedidosView::StringGridFieldsDrawCell(TObject *Sender,
...
void __fastcall TFListaPedidosView::StringGridFieldsSelectCell(TObject *Sender,
...
void __fastcall TFListaPedidosView::ButtonFiltroClick(TObject *Sender)
{
...
void __fastcall TFListaPedidosView::CheckFilterAdvancedClick(TObject *Sender)
{
...
void __fastcall TFListaPedidosView::StringGridFiltersDrawCell(TObject *Sender,
          int ACol, int ARow, TRect &Rect, TGridDrawState State)
{
    UnicodeString Texto;
	tagRECT *rc;
...
void __fastcall TFListaPedidosView::StringGridSortDrawCell(TObject *Sender, int ACol,
          int ARow, TRect &Rect, TGridDrawState State)
{
    UnicodeString Texto;
	tagRECT *rc;
...
void __fastcall TFListaPedidosView::StringGridFiltersSelectCell(TObject *Sender, int ACol,
          int ARow, bool &CanSelect)
{
...
void __fastcall TFListaPedidosView::StringGridFiltersMouseDown(TObject *Sender, TMouseButton Button,
...
void __fastcall TFListaPedidosView::StringGridFieldsMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	TList *fields = controller->getFields()->getVisible();
...
void __fastcall TFListaPedidosView::Button1Click(TObject *Sender)
{
    controller->deleteFilter();
}
//---------------------------------------------------------------------------

void __fastcall TFListaPedidosView::Button2Click(TObject *Sender)
{
    controller->addSort();
}
//---------------------------------------------------------------------------

void __fastcall TFListaPedidosView::Button3Click(TObject *Sender)
{
    controller->deleteSort();
}
//---------------------------------------------------------------------------

void __fastcall TFListaPedidosView::StringGridSortMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	TList *sortsList = controller->queryParams->sorts->sorts;
...
void __fastcall TFListaPedidosView::StringGridSortSelectCell(TObject *Sender, int ACol, int ARow,
          bool &CanSelect)
{
	rowselectSorts = ARow;
	colselectSorts = ACol;
...
void __fastcall TFListaPedidosView::FormShow(TObject *Sender)
{
	//STYLE DO FORM
	Style::setTop(LabelCabecalhoTitulo, LabelCabecalhoSubTitulo, "Pedidos");

	loadView();
}
//---------------------------------------------------------------------------

void __fastcall TFListaPedidosView::StringGrid1MouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
	if(helperGridRecords)
		if(helperGridRecords->checkBox)
